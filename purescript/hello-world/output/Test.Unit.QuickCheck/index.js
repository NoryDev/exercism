    ...
    return function (tries) {
        return function (prop) {
            return Control_Bind.bind(Control_Monad_Aff.bindAff)(Control_Monad_Eff_Class.liftEff(Control_Monad_Aff.monadEffAff)(Test_QuickCheck_LCG.randomSeed))(function (v) {
                ...
                var findErr = function (__copy_v1) {
                    var v1 = __copy_v1;
                    tco: while (true) {
                        ...
                        throw new Error("Failed pattern match at Test.Unit.QuickCheck line 18, column 26 - line 29, column 95: " + [ v1.constructor.name ]);
                    };
                };
                var $14 = findErr(results);
                if ($14 instanceof Data_Maybe.Nothing) {
                    return Test_Unit.success;
                };
                if ($14 instanceof Data_Maybe.Just) {
                    return Test_Unit.failure(Data_Show.show(Data_Show.showInt)(tries - wins) + ("/" + (Data_Show.show(Data_Show.showInt)(tries) + (" tests failed: " + $14.value0))));
                };
                throw new Error("Failed pattern match at Test.Unit.QuickCheck line 27, column 3 - line 29, column 95: " + [ $14.constructor.name ]);
            });
        };
    };
};
